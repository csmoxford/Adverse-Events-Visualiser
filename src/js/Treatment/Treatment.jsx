...
class Treatment extends Component {
  ...
  render() {
    ...
    const {data, totalHeight, filter, size, showDetails, selectedPatient} = this.props
    ...
    return <Switch>
      <Route key={0} path='/trialData/treatment/patient' render={() => <TreatmentPlotOuter  data={data} totalHeight={totalHeight} filter={filter} size={size} showDetails={showDetails} selectedPatient={selectedPatient} />}/>
